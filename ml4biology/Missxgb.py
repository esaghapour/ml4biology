...
class Missxgb(BaseEstimator, TransformerMixin):
    """Missing value imputation using Xgboost.
    ...
    * [3] https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.
    ...
    def __init__(self, max_iter=10, decreasing=False, missing_values=np.nan,
                 ...
                 min_child_weight=1.5,seed=42,
                 reg_alpha=0,reg_lambda=0,subsample=0.6,
    ...
    def _miss_xgboost(self, Ximp, mask):
        """The Missxgb algorithm"""
        ...
        if self.num_vars_ is not None:
            ...
            xgb_regressor = xgb.XGBRegressor(colsample_bytree=self.colsample_bytree,
                                     gamma=self.gamma,                 
        ...
        if self.cat_vars_ is not None:
            ...
            xgb_classifier = xgb.XGBClassifier(colsample_bytree=self.colsample_bytree,
                                     gamma=self.gamma,                 
                                     learning_rate=self.learning_rate,
                                     max_depth=self.max_depth,
                                     min_child_weight=self.min_child_weight,
        ...
        while (
            ...
            for s in misscount_idx:
                ...
                if self.cat_vars_ is not None and s in self.cat_vars_:
                    ...
                    clf=xgb_classifier.fit(xobs, yobs)
                    ...
                    clf=xgb_regressor.fit(xobs, yobs)
